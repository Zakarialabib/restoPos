<div>
    ...
    <x-theme.breadcrumb :title="__('Cash Register List')" :parent="route('admin.cash-register')" :parentName="__('Cash Register List')">
    ...
    <div class="flex flex-wrap justify-center">
        <div class="lg:w-1/2 md:w-1/2 sm:w-full flex flex-wrap gap-6 w-full items-center">
            ...
            @if ($selected)
                <x-button color="primary" type="button" wire:click="deleteSelected" class="ml-3">
                    {{ __('Delete') }}
                </x-button>
            @endif
    ...
    <livewire:admin.cashRegister.show />
