<div>
    ...
    <div class="bg-retro-cream min-h-screen w-full mx-auto mb-6" x-data="{
        ...
        <div class="flex flex-col lg:flex-row gap-8 my-4 p-6">
                    ...
                    @if (count($cart) > 0)
                        ...
                        @if ($showCheckout)
                            <div class="hidden md:flex">
                                <div class="my-4 w-full grid grid-cols-1 gap-y-6 justify-center items-center">
                                    <div>
            ...
            @if ($showSuccess)
                <div class="lg:w-1/4 order-2 lg:order-1">
                    <div class="border-retro-orange border-solid border-4 bg-white rounded-lg shadow-lg p-4 ">
                ...
                <div
                    ...
                    <div class="flex justify-between mt-8">
                        ...
                        <button wire:click="nextStep"
                            ...
                            x-show="step < 2" wire:loading.attr="disabled" wire:loading.class="opacity-50">
                            {{ __('Next') }}
                        </button>
